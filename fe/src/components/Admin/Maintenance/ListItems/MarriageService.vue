<template>
  <div class="marriage-service-list">
    <!-- Hero Image -->
    <div class="list-item">
      <div class="item-label">Hero Image</div>
      <div class="item-preview">
        <el-image
          v-if="marriageServiceData.heroImage"
          :src="marriageServiceData.heroImage"
          fit="cover"
          class="preview-image"
        />
      ...
      <div class="item-action">
        ...
        <span v-if="!marriageServiceData.heroImage" class="text-grey ml-2">No file chosen</span>
      </div>
    </div>
    <el-divider />
    ...
    <div class="list-item">
      ...
      <div class="item-preview">
        <span class="text-bold">{{ marriageServiceData.heroTitle }}</span>
      </div>
      <div class="item-action">
        <el-input
          v-model="marriageServiceData.heroTitle"
          size="small"
    ...
    <div class="list-item">
      ...
      <div class="item-preview">
        <span class="text-grey">{{ marriageServiceData.heroDescription }}</span>
      </div>
      <div class="item-action">
        <el-input
          v-model="marriageServiceData.heroDescription"
          type="textarea"
          :rows="3"
          size="small"
    ...
    <div class="list-item">
      ...
      <div class="item-preview">
        <span class="text-bold">{{ marriageServiceData.sectionTitle }}</span>
      </div>
      <div class="item-action">
        <el-input
          v-model="marriageServiceData.sectionTitle"
          size="small"
    ...
    <div class="list-item">
      ...
      <div class="item-preview">
        <span class="text-bold">{{ marriageServiceData.biblicalFoundationTitle }}</span>
      </div>
      <div class="item-action">
        <el-input
          v-model="marriageServiceData.biblicalFoundationTitle"
          size="small"
    ...
    <div class="list-item">
      ...
      <div class="item-preview">
        <span class="text-grey">{{ marriageServiceData.biblicalFoundationText }}</span>
      </div>
      <div class="item-action">
        <el-input
          v-model="marriageServiceData.biblicalFoundationText"
          type="textarea"
          :rows="4"
          size="small"
    ...
    <div class="list-item">
      ...
      <div class="item-preview">
        <span class="text-bold">{{ marriageServiceData.ourCommitmentTitle }}</span>
      </div>
      <div class="item-action">
        <el-input
          v-model="marriageServiceData.ourCommitmentTitle"
          size="small"
    ...
    <div class="list-item">
      ...
      <div class="item-preview">
        <span class="text-grey">{{ marriageServiceData.ourCommitmentText }}</span>
      </div>
      <div class="item-action">
        <el-input
          v-model="marriageServiceData.ourCommitmentText"
          type="textarea"
          :rows="4"
          size="small"
    ...
    <div class="list-item">
      ...
      <div class="item-preview">
        <span class="text-bold">{{ marriageServiceData.whatWeOfferTitle }}</span>
      </div>
      <div class="item-action">
        <el-input
          v-model="marriageServiceData.whatWeOfferTitle"
          size="small"
    ...
    <div class="list-item">
      ...
      <div class="item-preview">
        <span class="text-grey">{{ marriageServiceData.offerPoint1 }}</span>
      </div>
      <div class="item-action">
        <el-input
          v-model="marriageServiceData.offerPoint1"
          size="small"
    ...
    <div class="list-item">
      ...
      <div class="item-preview">
        <span class="text-grey">{{ marriageServiceData.offerPoint2 }}</span>
      </div>
      <div class="item-action">
        <el-input
          v-model="marriageServiceData.offerPoint2"
          size="small"
    ...
    <div class="list-item">
      ...
      <div class="item-preview">
        <span class="text-grey">{{ marriageServiceData.offerPoint3 }}</span>
      </div>
      <div class="item-action">
        <el-input
          v-model="marriageServiceData.offerPoint3"
          size="small"
...
const props = defineProps({
  ...
  activeSection: {
    type: String,
    required: true,
    default: 'marriageService'
  }
})

// Initialize CMS composable
const { loading, saving, loadPageData, savePageData } = useCms('marriageservice')

// Default data structure
const defaultMarriageServiceData = {
  heroImage: '',
...
const createReactiveCopy = (data) => {
  if (!data) return reactive(JSON.parse(JSON.stringify(defaultMarriageServiceData)))
  return reactive(JSON.parse(JSON.stringify(data)))
}

const marriageServiceData = props.marriageServiceData
  ? createReactiveCopy(props.marriageServiceData)
  : reactive(JSON.parse(JSON.stringify(defaultMarriageServiceData)))

// Load data from CMS on mount
onMounted(async () => {
  if (props.activeSection === 'marriageService') {
    const loadedData = await loadPageData()
    if (loadedData) {
      Object.keys(loadedData).forEach(key => {
        marriageServiceData[key] = loadedData[key]
      })
    }
  }
})
...
watch(() => props.marriageServiceData, (newData) => {
  if (newData) {
    const cloned = JSON.parse(JSON.stringify(newData))
    Object.keys(cloned).forEach(key => {
      marriageServiceData[key] = cloned[key]
    })
  }
}, { deep: true })
...
const handleHeroImageChange = (file) => {
  ...
  reader.onload = (e) => {
    marriageServiceData.heroImage = e.target.result
  }
...
const saveChanges = async () => {
  ...
  try {
    const contentToSave = JSON.parse(JSON.stringify(marriageServiceData))
    const imagesToSave = {}
    ...
    console.error('Error saving marriage service page:', error)
  }
}
</script>

<style scoped>
.marriage-service-list {
  width: 100%;
  padding-bottom: 80px;
}
